...
#### 2.4 大语言模型智能体系统
###### 1. 对话系统
* [与引领者，大篝火，医师的交互](#2.友好NPC)均为对话。其中医师的对话系统运用了大语言模型智能体系统，玩家可以自由地与医师沟通，他会捕捉关键字如"need heal"为玩家治疗血量，医师的设置在 AI.py 中实现。
###### 2. 决策系统
...
* `AI.py`该文件用于设置[医师NPC](#2.友好NPC)的对话ai
* `boss.py` 
* `game_collections.py` 该文件定义了
	...
	* 文本类 `TextLike`， 类对象用于给交互系统（如[升级系统，对话系统](#3.资源系统)，[菜单](#1.主菜单)）提供文本。
...
* `scene.py `该文件用于管理游戏中的所有场景，其中包含
	* [地图生成器类 `MapGenerator`](#2.场景数量) 用于生成不同难度的战斗场景。
